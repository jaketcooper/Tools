...
public class TextInputLayout extends LinearLayout {
    ...
    public TextInputLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (a.getResourceId(C0023R.styleable.TextInputLayout_hintTextAppearance, -1) != -1) {
        ...
        setCounterMaxLength(a.getInt(C0023R.styleable.TextInputLayout_counterMaxLength, -1));
        ...
        if (a.hasValue(C0023R.styleable.TextInputLayout_passwordToggleTintMode)) {
            ...
            this.mPasswordToggleTintMode = ViewUtils.parseTintMode(a.getInt(C0023R.styleable.TextInputLayout_passwordToggleTintMode, -1), (PorterDuff.Mode) null);
        }
        a.recycle();
    ...
    public void setErrorEnabled(boolean enabled) {
        if (this.mErrorEnabled != enabled) {
            ...
            if (enabled) {
                ...
                this.mErrorView.setId(C0023R.C0025id.textinput_error);
                ...
                if (useDefaultColor) {
                    TextViewCompat.setTextAppearance(this.mErrorView, C0357R.style.TextAppearance_AppCompat_Caption);
                    this.mErrorView.setTextColor(ContextCompat.getColor(getContext(), C0357R.color.error_color_material));
                }
    ...
    public void setCounterEnabled(boolean enabled) {
        if (this.mCounterEnabled != enabled) {
            if (enabled) {
                ...
                this.mCounterView.setId(C0023R.C0025id.textinput_counter);
                if (this.mTypeface != null) {
                ...
                try {
                    ...
                    TextViewCompat.setTextAppearance(this.mCounterView, C0357R.style.TextAppearance_AppCompat_Caption);
                    this.mCounterView.setTextColor(ContextCompat.getColor(getContext(), C0357R.color.error_color_material));
                }
        ...
        if (this.mEditText != null) {
            if (shouldShowPasswordIcon()) {
                if (this.mPasswordToggleView == null) {
                    this.mPasswordToggleView = (CheckableImageButton) LayoutInflater.from(getContext()).inflate(C0023R.C0026layout.design_text_input_password_icon, this.mInputFrame, false);
