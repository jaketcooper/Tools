...
public class AppBarLayout extends LinearLayout {
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        ...
        if (a.hasValue(C0023R.styleable.AppBarLayout_expanded)) {
            setExpanded(a.getBoolean(C0023R.styleable.AppBarLayout_expanded, false), false, false);
        }
        if (Build.VERSION.SDK_INT >= 21 && a.hasValue(C0023R.styleable.AppBarLayout_elevation)) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            if (a.hasValue(C0023R.styleable.AppBarLayout_android_keyboardNavigationCluster)) {
                setKeyboardNavigationCluster(a.getBoolean(C0023R.styleable.AppBarLayout_android_keyboardNavigationCluster, false));
            }
            if (a.hasValue(C0023R.styleable.AppBarLayout_android_touchscreenBlocksFocus)) {
                setTouchscreenBlocksFocus(a.getBoolean(C0023R.styleable.AppBarLayout_android_touchscreenBlocksFocus, false));
            }
        }
        a.recycle();
    ...
    public int[] onCreateDrawableState(int extraSpace) {
        ...
        extraStates[1] = (!this.mCollapsible || !this.mCollapsed) ? -C0023R.attr.state_collapsed : C0023R.attr.state_collapsed;
