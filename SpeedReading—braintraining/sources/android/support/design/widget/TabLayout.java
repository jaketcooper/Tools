...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mTabStrip.setSelectedIndicatorHeight(a.getDimensionPixelSize(C0023R.styleable.TabLayout_tabIndicatorHeight, 0));
        this.mTabStrip.setSelectedIndicatorColor(a.getColor(C0023R.styleable.TabLayout_tabIndicatorColor, 0));
        int dimensionPixelSize = a.getDimensionPixelSize(C0023R.styleable.TabLayout_tabPadding, 0);
        ...
        TypedArray ta = context.obtainStyledAttributes(this.mTabTextAppearance, C0357R.styleable.TextAppearance);
        try {
            this.mTabTextSize = (float) ta.getDimensionPixelSize(C0357R.styleable.TextAppearance_android_textSize, 0);
            this.mTabTextColors = ta.getColorStateList(C0357R.styleable.TextAppearance_android_textColor);
            ta.recycle();
            ...
            if (a.hasValue(C0023R.styleable.TabLayout_tabSelectedTextColor)) {
                this.mTabTextColors = createColorStateList(this.mTabTextColors.getDefaultColor(), a.getColor(C0023R.styleable.TabLayout_tabSelectedTextColor, 0));
            }
            this.mRequestedTabMinWidth = a.getDimensionPixelSize(C0023R.styleable.TabLayout_tabMinWidth, -1);
            this.mRequestedTabMaxWidth = a.getDimensionPixelSize(C0023R.styleable.TabLayout_tabMaxWidth, -1);
            this.mTabBackgroundResId = a.getResourceId(C0023R.styleable.TabLayout_tabBackground, 0);
            this.mContentInsetStart = a.getDimensionPixelSize(C0023R.styleable.TabLayout_tabContentStart, 0);
            this.mMode = a.getInt(C0023R.styleable.TabLayout_tabMode, 1);
            this.mTabGravity = a.getInt(C0023R.styleable.TabLayout_tabGravity, 0);
            a.recycle();
    ...
    class TabView extends LinearLayout {
        ...
        public final void update() {
            ...
            if (this.mCustomView == null) {
                if (this.mIconView == null) {
                    ImageView iconView = (ImageView) LayoutInflater.from(getContext()).inflate(C0023R.C0026layout.design_layout_tab_icon, this, false);
                    addView(iconView, 0);
                    this.mIconView = iconView;
                }
                if (this.mTextView == null) {
                    TextView textView = (TextView) LayoutInflater.from(getContext()).inflate(C0023R.C0026layout.design_layout_tab_text, this, false);
                    addView(textView);
