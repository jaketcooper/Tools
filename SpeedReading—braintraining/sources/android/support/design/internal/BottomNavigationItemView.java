...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(C0023R.C0026layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C0023R.C0024drawable.design_bottom_navigation_item_background);
        this.mIcon = (ImageView) findViewById(C0023R.C0025id.icon);
        this.mSmallLabel = (TextView) findViewById(C0023R.C0025id.smallLabel);
        this.mLargeLabel = (TextView) findViewById(C0023R.C0025id.largeLabel);
    }
