    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C0357R.C0359id.topPanel) {
                    topPanel = child;
                } else if (id == C0357R.C0359id.buttonPanel) {
                    buttonPanel = child;
                } else if ((id != C0357R.C0359id.contentPanel && id != C0357R.C0359id.customPanel) || middlePanel != null) {
                    return false;
                } else {
                    middlePanel = child;
                }
