...
public class AlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    static int resolveDialogTheme(@NonNull Context context, @StyleRes int resid) {
        ...
        context.getTheme().resolveAttribute(C0357R.attr.alertDialogTheme, outValue, true);
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context, @StyleRes int themeResId) {
            this.f29P = new AlertController.AlertParams(new ContextThemeWrapper(context, AlertDialog.resolveDialogTheme(context, themeResId)));
        ...
        public Builder setTitle(@StringRes int titleId) {
            this.f29P.mTitle = this.f29P.mContext.getText(titleId);
            return this;
        }

        public Builder setTitle(@Nullable CharSequence title) {
            this.f29P.mTitle = title;
            return this;
        }

        public Builder setCustomTitle(@Nullable View customTitleView) {
            this.f29P.mCustomTitleView = customTitleView;
            return this;
        }

        public Builder setMessage(@StringRes int messageId) {
            this.f29P.mMessage = this.f29P.mContext.getText(messageId);
            return this;
        }

        public Builder setMessage(@Nullable CharSequence message) {
            this.f29P.mMessage = message;
            return this;
        }

        public Builder setIcon(@DrawableRes int iconId) {
            this.f29P.mIconId = iconId;
            return this;
        }

        public Builder setIcon(@Nullable Drawable icon) {
            this.f29P.mIcon = icon;
            return this;
        }

        public Builder setIconAttribute(@AttrRes int attrId) {
            TypedValue out = new TypedValue();
            this.f29P.mContext.getTheme().resolveAttribute(attrId, out, true);
            this.f29P.mIconId = out.resourceId;
            return this;
        }

        public Builder setPositiveButton(@StringRes int textId, DialogInterface.OnClickListener listener) {
            this.f29P.mPositiveButtonText = this.f29P.mContext.getText(textId);
            this.f29P.mPositiveButtonListener = listener;
            return this;
        }

        public Builder setPositiveButton(CharSequence text, DialogInterface.OnClickListener listener) {
            this.f29P.mPositiveButtonText = text;
            this.f29P.mPositiveButtonListener = listener;
            return this;
        }

        public Builder setNegativeButton(@StringRes int textId, DialogInterface.OnClickListener listener) {
            this.f29P.mNegativeButtonText = this.f29P.mContext.getText(textId);
            this.f29P.mNegativeButtonListener = listener;
            return this;
        }

        public Builder setNegativeButton(CharSequence text, DialogInterface.OnClickListener listener) {
            this.f29P.mNegativeButtonText = text;
            this.f29P.mNegativeButtonListener = listener;
            return this;
        }

        public Builder setNeutralButton(@StringRes int textId, DialogInterface.OnClickListener listener) {
            this.f29P.mNeutralButtonText = this.f29P.mContext.getText(textId);
            this.f29P.mNeutralButtonListener = listener;
            return this;
        }

        public Builder setNeutralButton(CharSequence text, DialogInterface.OnClickListener listener) {
            this.f29P.mNeutralButtonText = text;
            this.f29P.mNeutralButtonListener = listener;
            return this;
        }

        public Builder setCancelable(boolean cancelable) {
            this.f29P.mCancelable = cancelable;
            return this;
        }
        ...
        public Builder setItems(@ArrayRes int itemsId, DialogInterface.OnClickListener listener) {
            this.f29P.mItems = this.f29P.mContext.getResources().getTextArray(itemsId);
            this.f29P.mOnClickListener = listener;
            return this;
        }

        public Builder setItems(CharSequence[] items, DialogInterface.OnClickListener listener) {
            this.f29P.mItems = items;
            this.f29P.mOnClickListener = listener;
            return this;
        }

        public Builder setAdapter(ListAdapter adapter, DialogInterface.OnClickListener listener) {
            this.f29P.mAdapter = adapter;
            this.f29P.mOnClickListener = listener;
            return this;
        }
        ...
        public Builder setCursor(Cursor cursor, DialogInterface.OnClickListener listener, String labelColumn) {
            ...
            this.f29P.mLabelColumn = labelColumn;
            this.f29P.mOnClickListener = listener;
            return this;
        }
        ...
        public Builder setMultiChoiceItems(@ArrayRes int itemsId, boolean[] checkedItems, DialogInterface.OnMultiChoiceClickListener listener) {
            this.f29P.mItems = this.f29P.mContext.getResources().getTextArray(itemsId);
            this.f29P.mOnCheckboxClickListener = listener;
            this.f29P.mCheckedItems = checkedItems;
        ...
        public Builder setMultiChoiceItems(Cursor cursor, String isCheckedColumn, String labelColumn, DialogInterface.OnMultiChoiceClickListener listener) {
            this.f29P.mCursor = cursor;
            this.f29P.mOnCheckboxClickListener = listener;
            this.f29P.mIsCheckedColumn = isCheckedColumn;
            this.f29P.mLabelColumn = labelColumn;
            this.f29P.mIsMultiChoice = true;
            return this;
        }
        ...
        public Builder setSingleChoiceItems(@ArrayRes int itemsId, int checkedItem, DialogInterface.OnClickListener listener) {
            this.f29P.mItems = this.f29P.mContext.getResources().getTextArray(itemsId);
            this.f29P.mOnClickListener = listener;
            this.f29P.mCheckedItem = checkedItem;
        ...
        public Builder setOnItemSelectedListener(AdapterView.OnItemSelectedListener listener) {
            this.f29P.mOnItemSelectedListener = listener;
            return this;
        }

        public Builder setView(int layoutResId) {
            this.f29P.mView = null;
            this.f29P.mViewLayoutResId = layoutResId;
        ...
        public Builder setView(View view, int viewSpacingLeft, int viewSpacingTop, int viewSpacingRight, int viewSpacingBottom) {
            ...
            this.f29P.mViewSpacingLeft = viewSpacingLeft;
            this.f29P.mViewSpacingTop = viewSpacingTop;
            this.f29P.mViewSpacingRight = viewSpacingRight;
            this.f29P.mViewSpacingBottom = viewSpacingBottom;
            return this;
        }

        @Deprecated
        public Builder setInverseBackgroundForced(boolean useInverseBackground) {
            this.f29P.mForceInverseBackground = useInverseBackground;
            return this;
        }

        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public Builder setRecycleOnMeasureEnabled(boolean enabled) {
            this.f29P.mRecycleOnMeasure = enabled;
            return this;
        }

        public AlertDialog create() {
            AlertDialog dialog = new AlertDialog(this.f29P.mContext, this.mTheme);
            this.f29P.apply(dialog.mAlert);
            dialog.setCancelable(this.f29P.mCancelable);
            if (this.f29P.mCancelable) {
                dialog.setCanceledOnTouchOutside(true);
            }
            dialog.setOnCancelListener(this.f29P.mOnCancelListener);
            dialog.setOnDismissListener(this.f29P.mOnDismissListener);
            if (this.f29P.mOnKeyListener != null) {
                dialog.setOnKeyListener(this.f29P.mOnKeyListener);
            }
            return dialog;
        }
