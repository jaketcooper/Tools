...
class PathInterpolatorApi14 implements Interpolator {
    ...
    public float getInterpolation(float t) {
        ...
        float xRange = this.f27mX[endIndex] - this.f27mX[startIndex];
        if (xRange == 0.0f) {
            return this.f28mY[startIndex];
        }
        float startY = this.f28mY[startIndex];
        return ((this.f28mY[endIndex] - startY) * ((t - this.f27mX[startIndex]) / xRange)) + startY;
    }
