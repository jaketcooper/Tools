...
public final class FontRequest {
    ...
    public FontRequest(@NonNull String providerAuthority, @NonNull String providerPackage, @NonNull String query, @NonNull List<List<byte[]>> certificates) {
        ...
        this.mIdentifier = this.mProviderAuthority + SchulteTableFragment.NON_INITIALIZATION_VALUE + this.mProviderPackage + SchulteTableFragment.NON_INITIALIZATION_VALUE + this.mQuery;
    }
