...
import android.support.constraint.C0009R;
...
public abstract class ConstraintHelper extends View {
    ...
    public void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            for (int i = 0; i < N; i++) {
                ...
                if (attr == C0009R.styleable.ConstraintLayout_Layout_constraint_referenced_ids) {
    ...
    private void addID(String idString) {
        ...
        if (idString != null && this.myContext != null) {
            ...
            int tag = 0;
            try {
                tag = C0009R.C0010id.class.getField(idString2).getInt((Object) null);
            } catch (Exception e) {
            }
            if (tag == 0) {
                tag = this.myContext.getResources().getIdentifier(idString2, IdentityRealmObject.FIELD_ID, this.myContext.getPackageName());
            }
