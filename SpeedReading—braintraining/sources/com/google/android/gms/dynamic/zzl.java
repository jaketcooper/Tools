...
public abstract class zzl extends zzee implements zzk {
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
        ...
        switch (i) {
            case 2:
                IObjectWrapper zzapm = zzapm();
                parcel2.writeNoException();
                zzef.zza(parcel2, (IInterface) zzapm);
                break;
            case 3:
            ...
            case 5:
                zzk zzapn = zzapn();
                parcel2.writeNoException();
                zzef.zza(parcel2, (IInterface) zzapn);
                break;
            case 6:
                IObjectWrapper zzapo = zzapo();
                parcel2.writeNoException();
                zzef.zza(parcel2, (IInterface) zzapo);
                break;
            case 7:
            ...
            case 9:
                zzk zzapp = zzapp();
                parcel2.writeNoException();
                zzef.zza(parcel2, (IInterface) zzapp);
                break;
            case 10:
