...
final class zzl<TResult> {
    ...
    private Queue<zzk<TResult>> zzksa;
    private boolean zzksb;
    ...
    public final void zzb(@android.support.annotation.NonNull com.google.android.gms.tasks.Task<TResult> r3) {
        /*
            ...
            monitor-enter(r1)
            java.util.Queue<com.google.android.gms.tasks.zzk<TResult>> r0 = r2.zzksa     // Catch:{ all -> 0x0026 }
            if (r0 == 0) goto L_0x000b
            boolean r0 = r2.zzksb     // Catch:{ all -> 0x0026 }
        ...
        L_0x000d:
            r0 = 1
            r2.zzksb = r0     // Catch:{ all -> 0x0026 }
            monitor-exit(r1)     // Catch:{ all -> 0x0026 }
        L_0x0011:
            java.lang.Object r1 = r2.mLock
            monitor-enter(r1)
            java.util.Queue<com.google.android.gms.tasks.zzk<TResult>> r0 = r2.zzksa     // Catch:{ all -> 0x0023 }
