...
public final class zzhj {
    ...
    private final boolean zza(java.lang.String r12, java.util.HashSet<java.lang.String> r13) {
        ...
        L_0x0073:
            ...
            r11.zzazv = r2
        L_0x0077:
            java.lang.String[] r7 = com.google.android.gms.internal.zzhd.zzb(r2, r3)
            int r2 = r7.length
            int r4 = r11.zzazy
        ...
        L_0x00e2:
            ...
            goto L_0x0077
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.zzhj.zza(java.lang.String, java.util.HashSet):boolean");
    }
    ...
    public final String zza(ArrayList<String> arrayList, ArrayList<zzgy> arrayList2) {
        ...
        while (true) {
            int i2 = i;
            if (i2 >= arrayList2.size() || !zza(Normalizer.normalize(arrayList.get(arrayList2.get(i2).zzgz()), Normalizer.Form.NFKC).toLowerCase(Locale.US), (HashSet<String>) hashSet)) {
                zzhc zzhc = new zzhc();
                this.zzazu = "";
        ...
        while (it2.hasNext()) {
            try {
                zzhc2.write(this.zzazm.zzx((String) it2.next()));
            } catch (IOException e) {
                zzafj.zzb("Error while writing hash to byteStream", e);
            }
        }
        return zzhc2.toString();
    }
}
