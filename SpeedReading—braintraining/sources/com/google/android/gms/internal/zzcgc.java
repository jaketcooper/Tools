    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
        ...
        switch (i) {
            ...
            case 6:
                ...
                break;
            case 7:
                List<zzckk> zza = zza((zzcff) zzef.zza(parcel, zzcff.CREATOR), zzef.zza(parcel));
                parcel2.writeNoException();
            ...
            case 13:
                ...
                break;
            case 14:
                List<zzckk> zza3 = zza(parcel.readString(), parcel.readString(), zzef.zza(parcel), (zzcff) zzef.zza(parcel, zzcff.CREATOR));
                parcel2.writeNoException();
                parcel2.writeTypedList(zza3);
                break;
            case 15:
                List<zzckk> zza4 = zza(parcel.readString(), parcel.readString(), parcel.readString(), zzef.zza(parcel));
                parcel2.writeNoException();
                parcel2.writeTypedList(zza4);
                break;
            case 16:
                List<zzcfi> zza5 = zza(parcel.readString(), parcel.readString(), (zzcff) zzef.zza(parcel, zzcff.CREATOR));
                parcel2.writeNoException();
                parcel2.writeTypedList(zza5);
                break;
            case 17:
                List<zzcfi> zzj = zzj(parcel.readString(), parcel.readString(), parcel.readString());
                parcel2.writeNoException();
