...
public final class zzaa {
    private static zzaa zznvo;
    private final SimpleArrayMap<String, String> zznvp = new SimpleArrayMap<>();
    private Boolean zznvq = null;
    @VisibleForTesting
    final Queue<Intent> zznvr = new LinkedList();
    @VisibleForTesting
    private Queue<Intent> zznvs = new LinkedList();
    ...
    public static synchronized zzaa zzchn() {
        zzaa zzaa;
    ...
    private final int zzd(android.content.Context r7, android.content.Intent r8) {
        /*
            r6 = this;
            r2 = 0
            android.support.v4.util.SimpleArrayMap<java.lang.String, java.lang.String> r1 = r6.zznvp
            monitor-enter(r1)
            android.support.v4.util.SimpleArrayMap<java.lang.String, java.lang.String> r0 = r6.zznvp     // Catch:{ all -> 0x0053 }
        ...
        L_0x0028:
            java.lang.Boolean r0 = r6.zznvq     // Catch:{ SecurityException -> 0x0115, IllegalStateException -> 0x0124 }
        ...
        L_0x0035:
            ...
            r6.zznvq = r0     // Catch:{ SecurityException -> 0x0115, IllegalStateException -> 0x0124 }
        L_0x003b:
            java.lang.Boolean r0 = r6.zznvq     // Catch:{ SecurityException -> 0x0115, IllegalStateException -> 0x0124 }
        ...
        L_0x00c2:
            android.support.v4.util.SimpleArrayMap<java.lang.String, java.lang.String> r1 = r6.zznvp
            monitor-enter(r1)
            android.support.v4.util.SimpleArrayMap<java.lang.String, java.lang.String> r3 = r6.zznvp     // Catch:{ all -> 0x00fc }
    ...
    public final int zza(Context context, String str, Intent intent) {
        ...
        switch (c) {
            case 0:
                this.zznvr.offer(intent);
                break;
            case 1:
                this.zznvs.offer(intent);
                break;
            default:
    ...
    public final Intent zzcho() {
        return this.zznvs.poll();
    }
}
