...
public final class FirebaseAnalytics {
    ...
    public FirebaseAnalytics(zzchj zzchj) {
    ...
    public static FirebaseAnalytics getInstance(Context context) {
        return zzchj.zzdu(context).zzazp();
    }

    public final Task<String> getAppInstanceId() {
        return this.zzitu.zzawb().getAppInstanceId();
    }

    public final void logEvent(@Size(max = 40, min = 1) @NonNull String str, Bundle bundle) {
        this.zzitu.zzazo().logEvent(str, bundle);
    }

    public final void resetAnalyticsData() {
        this.zzitu.zzawb().resetAnalyticsData();
    }

    public final void setAnalyticsCollectionEnabled(boolean z) {
        this.zzitu.zzazo().setMeasurementEnabled(z);
    }

    @Keep
    @MainThread
    public final void setCurrentScreen(@NonNull Activity activity, @Nullable @Size(max = 36, min = 1) String str, @Nullable @Size(max = 36, min = 1) String str2) {
        this.zzitu.zzawf().setCurrentScreen(activity, str, str2);
    }

    public final void setMinimumSessionDuration(long j) {
        this.zzitu.zzazo().setMinimumSessionDuration(j);
    }

    public final void setSessionTimeoutDuration(long j) {
        this.zzitu.zzazo().setSessionTimeoutDuration(j);
    }

    public final void setUserId(String str) {
        this.zzitu.zzazo().setUserPropertyInternal("app", "_id", str);
    }

    public final void setUserProperty(@Size(max = 24, min = 1) @NonNull String str, @Nullable @Size(max = 36) String str2) {
        this.zzitu.zzazo().setUserProperty(str, str2);
    }
}
