...
public class MarkerImage implements IMarker {
    ...
    public void setOffset(float offsetX, float offsetY) {
        this.mOffset.f75x = offsetX;
        this.mOffset.f76y = offsetY;
    }
    ...
    public MPPointF getOffsetForDrawingAtPoint(float posX, float posY) {
        ...
        this.mOffset2.f75x = offset.f75x;
        this.mOffset2.f76y = offset.f76y;
        ...
        if (this.mOffset2.f75x + posX < 0.0f) {
            this.mOffset2.f75x = -posX;
        } else if (chart != null && posX + width + this.mOffset2.f75x > ((float) chart.getWidth())) {
            this.mOffset2.f75x = (((float) chart.getWidth()) - posX) - width;
        }
        if (this.mOffset2.f76y + posY < 0.0f) {
            this.mOffset2.f76y = -posY;
        } else if (chart != null && posY + height + this.mOffset2.f76y > ((float) chart.getHeight())) {
            this.mOffset2.f76y = (((float) chart.getHeight()) - posY) - height;
        }
    ...
    public void draw(Canvas canvas, float posX, float posY) {
        if (this.mDrawable != null) {
            ...
            canvas.translate(offset.f75x + posX, offset.f76y + posY);
