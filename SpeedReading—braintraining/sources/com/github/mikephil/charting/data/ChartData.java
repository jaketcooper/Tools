...
public abstract class ChartData<T extends IDataSet<? extends Entry>> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:7:0x0016, code lost:
        r0 = r1.removeEntry(r4);
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean removeEntry(com.github.mikephil.charting.data.Entry r4, int r5) {
        /*
            r3 = this;
            r0 = 0
            if (r4 == 0) goto L_0x000b
            java.util.List<T> r2 = r3.mDataSets
            int r2 = r2.size()
        ...
        L_0x000c:
            ...
            boolean r0 = r1.removeEntry(r4)
            if (r0 == 0) goto L_0x000b
            r3.calcMinMax()
            goto L_0x000b
        */
        throw new UnsupportedOperationException("Method not decompiled: com.github.mikephil.charting.data.ChartData.removeEntry(com.github.mikephil.charting.data.Entry, int):boolean");
    }
