...
public class ColorTemplate {
    public static final int[] COLORFUL_COLORS = {Color.rgb(193, 37, 82), Color.rgb(255, 102, 0), Color.rgb(HebrewProber.FINAL_TSADI, 199, 0), Color.rgb(106, MovementView.SHOW_ANSWER_DELAY, 31), Color.rgb(179, 100, 53)};
    ...
    public static final int[] LIBERTY_COLORS = {Color.rgb(207, 248, HebrewProber.NORMAL_TSADI), Color.rgb(148, 212, 212), Color.rgb(136, 180, 187), Color.rgb(118, 174, 175), Color.rgb(42, 109, SJISContextAnalysis.HIRAGANA_HIGHBYTE)};
    ...
    public static final int[] VORDIPLOM_COLORS = {Color.rgb(192, 255, 140), Color.rgb(255, 247, 140), Color.rgb(255, 208, 140), Color.rgb(140, HebrewProber.FINAL_KAF, 255), Color.rgb(255, 140, 157)};
