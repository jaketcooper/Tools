...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends ViewGroup implements ChartInterface {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.mData == null) {
            ...
            if (hasText) {
                ...
                canvas.drawText(this.mNoDataText, c.f75x, c.f76y, this.mInfoPaint);
            }
    ...
    public boolean saveToGallery(String fileName, String subFolderPath, String fileDescription, Bitmap.CompressFormat format, int quality) {
        ...
        switch (C05452.$SwitchMap$android$graphics$Bitmap$CompressFormat[format.ordinal()]) {
            case 1:
                mimeType = "image/png";
        ...
        try {
            ...
            try {
                ...
                values.put(BookDescriptionDatabaseHelper.BOOK_TITLE, fileName);
