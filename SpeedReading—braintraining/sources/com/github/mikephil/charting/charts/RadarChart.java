...
public class RadarChart extends PieRadarChartBase<RadarData> {
    ...
    private int mWebAlpha = MovementView.SHOW_ANSWER_DELAY;
    private int mWebColor = Color.rgb(CharsetProber.ASCII_Z, CharsetProber.ASCII_Z, CharsetProber.ASCII_Z);
    private int mWebColorInner = Color.rgb(CharsetProber.ASCII_Z, CharsetProber.ASCII_Z, CharsetProber.ASCII_Z);
