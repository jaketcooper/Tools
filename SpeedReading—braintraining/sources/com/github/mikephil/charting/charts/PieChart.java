...
public class PieChart extends PieRadarChartBase<PieData> {
    ...
    public void calculateOffsets() {
        ...
        if (this.mData != null) {
            ...
            this.mCircleBox.set((c.f75x - radius) + shift, (c.f76y - radius) + shift, (c.f75x + radius) - shift, (c.f76y + radius) - shift);
    ...
    public float[] getMarkerPosition(Highlight highlight) {
        ...
        float x = (float) ((((double) r2) * Math.cos(Math.toRadians((double) (((this.mAbsoluteAngles[entryIndex] + rotationAngle) - offset) * this.mAnimator.getPhaseY())))) + ((double) center.f75x));
        float y = (float) ((((double) r2) * Math.sin(Math.toRadians((double) (((this.mAbsoluteAngles[entryIndex] + rotationAngle) - offset) * this.mAnimator.getPhaseY())))) + ((double) center.f76y));
    ...
    public void setCenterTextOffset(float x, float y) {
        this.mCenterTextOffset.f75x = Utils.convertDpToPixel(x);
        this.mCenterTextOffset.f76y = Utils.convertDpToPixel(y);
    }

    public MPPointF getCenterTextOffset() {
        return MPPointF.getInstance(this.mCenterTextOffset.f75x, this.mCenterTextOffset.f76y);
    }
