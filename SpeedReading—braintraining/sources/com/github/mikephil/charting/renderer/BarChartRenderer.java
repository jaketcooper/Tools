                        ...
                        for (int j = 0; ((float) j) < ((float) buffer.buffer.length) * this.mAnimator.getPhaseX(); j += 4) {
                            ...
                            if (this.mViewPortHandler.isInBoundsY(buffer.buffer[j + 1]) && this.mViewPortHandler.isInBoundsLeft(x)) {
                                ...
                                if (dataSet.isDrawValuesEnabled()) {
                                    ...
                                    drawValue(c, valueFormatter, val, entry, i, x, f3, dataSet.getValueTextColor(j / 4));
                                }
                                if (entry.getIcon() != null && dataSet.isDrawIconsEnabled()) {
                                    ...
                                    Utils.drawImage(c, icon, (int) (px + iconsOffset.f75x), (int) (py + iconsOffset.f76y), icon.getIntrinsicWidth(), icon.getIntrinsicHeight());
                                }
                            }
                        }
                    } else {
                            ...
                            if (vals == null) {
                                if (!this.mViewPortHandler.isInBoundsRight(x2)) {
                                    ...
                                    if (entry2.getIcon() != null && dataSet.isDrawIconsEnabled()) {
                                        ...
                                        Utils.drawImage(c, icon2, (int) (px2 + iconsOffset.f75x), (int) (f4 + f2 + iconsOffset.f76y), icon2.getIntrinsicWidth(), icon2.getIntrinsicHeight());
                                    }
                                }
                            } else {
                                ...
                                for (int k2 = 0; k2 < transformed.length; k2 += 2) {
                                    ...
                                    if (this.mViewPortHandler.isInBoundsY(y2) && this.mViewPortHandler.isInBoundsLeft(x2)) {
                                        ...
                                        if (entry2.getIcon() != null && dataSet.isDrawIconsEnabled()) {
                                            ...
                                            Utils.drawImage(c, icon3, (int) (iconsOffset.f75x + x2), (int) (iconsOffset.f76y + y2), icon3.getIntrinsicWidth(), icon3.getIntrinsicHeight());
                                        }
                                    }
                                }
                            }
