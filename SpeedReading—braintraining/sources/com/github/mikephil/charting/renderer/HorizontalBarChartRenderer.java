                        ...
                        for (int j = 0; ((float) j) < ((float) buffer.buffer.length) * this.mAnimator.getPhaseX(); j += 4) {
                            ...
                            if (this.mViewPortHandler.isInBoundsX(buffer.buffer[j]) && this.mViewPortHandler.isInBoundsBottom(buffer.buffer[j + 1])) {
                                ...
                                if (entry.getIcon() != null && dataSet.isDrawIconsEnabled()) {
                                    ...
                                    Utils.drawImage(c, icon, (int) (f7 + f4 + iconsOffset.f75x), (int) (y2 + iconsOffset.f76y), icon.getIntrinsicWidth(), icon.getIntrinsicHeight());
                                }
                            }
                        }
                    } else {
                        ...
                        while (((float) index) < ((float) dataSet.getEntryCount()) * this.mAnimator.getPhaseX()) {
                            ...
                            if (vals == null) {
                                if (!this.mViewPortHandler.isInBoundsTop(buffer.buffer[bufferIndex + 1])) {
                                    ...
                                    String formattedValue2 = formatter.getFormattedValue(entry2.getY(), entry2, i, this.mViewPortHandler);
                                    ...
                                    if (entry2.getIcon() != null && dataSet.isDrawIconsEnabled()) {
                                        ...
                                        Utils.drawImage(c, icon2, (int) (f9 + f2 + iconsOffset.f75x), (int) (buffer.buffer[bufferIndex + 1] + iconsOffset.f76y), icon2.getIntrinsicWidth(), icon2.getIntrinsicHeight());
                                    }
                                }
                            } else {
                                ...
                                for (int k2 = 0; k2 < transformed.length; k2 += 2) {
                                    ...
                                    String formattedValue3 = formatter.getFormattedValue(val2, entry2, i, this.mViewPortHandler);
                                    ...
                                    if (this.mViewPortHandler.isInBoundsX(x) && this.mViewPortHandler.isInBoundsBottom(y3)) {
                                        ...
                                        if (entry2.getIcon() != null && dataSet.isDrawIconsEnabled()) {
                                            ...
                                            Utils.drawImage(c, icon3, (int) (iconsOffset.f75x + x), (int) (iconsOffset.f76y + y3), icon3.getIntrinsicWidth(), icon3.getIntrinsicHeight());
                                        }
                                    }
                                }
                            }
