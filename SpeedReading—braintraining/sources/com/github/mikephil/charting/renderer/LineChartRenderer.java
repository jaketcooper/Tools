                    ...
                    for (int j = 0; j < positions.length; j += 2) {
                        ...
                        if (this.mViewPortHandler.isInBoundsLeft(x) && this.mViewPortHandler.isInBoundsY(y)) {
                            ...
                            if (entry.getIcon() != null && dataSet.isDrawIconsEnabled()) {
                                ...
                                Utils.drawImage(c, icon, (int) (iconsOffset.f75x + x), (int) (iconsOffset.f76y + y), icon.getIntrinsicWidth(), icon.getIntrinsicHeight());
                            }
                        }
                    }
    ...
    public void drawCircles(Canvas c) {
        ...
        for (int i = 0; i < dataSets.size(); i++) {
            ...
            if (dataSet.isVisible() && dataSet.isDrawCirclesEnabled() && dataSet.getEntryCount() != 0) {
                ...
                while (j <= boundsRangeCount && (e = dataSet.getEntryForIndex(j)) != null) {
                    ...
                    if (this.mViewPortHandler.isInBoundsLeft(this.mCirclesBuffer[0]) && this.mViewPortHandler.isInBoundsY(this.mCirclesBuffer[1]) && (circleBitmap = imageCache.getBitmap(j)) != null) {
