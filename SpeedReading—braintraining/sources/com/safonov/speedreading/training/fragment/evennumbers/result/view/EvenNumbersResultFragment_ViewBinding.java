...
public class EvenNumbersResultFragment_ViewBinding implements Unbinder {
    private EvenNumbersResultFragment target;

    @UiThread
    public EvenNumbersResultFragment_ViewBinding(EvenNumbersResultFragment target2, View source) {
        this.target = target2;
        target2.scoreTextView = (TextView) Utils.findRequiredViewAsType(source, R.id.result_score_text_view, "field 'scoreTextView'", TextView.class);
        ...
        target2.lineChart = (LineChart) Utils.findRequiredViewAsType(source, R.id.even_numbers_result_line_chart_view, "field 'lineChart'", LineChart.class);
    ...
    @CallSuper
    public void unbind() {
        EvenNumbersResultFragment target2 = this.target;
        if (target2 == null) {
