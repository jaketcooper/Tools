...
public class EvenNumbersPassCourseResultFragment_ViewBinding implements Unbinder {
    ...
    @UiThread
    public EvenNumbersPassCourseResultFragment_ViewBinding(final EvenNumbersPassCourseResultFragment target2, View source) {
        this.target = target2;
    ...
    @CallSuper
    public void unbind() {
        EvenNumbersPassCourseResultFragment target2 = this.target;
        if (target2 == null) {
