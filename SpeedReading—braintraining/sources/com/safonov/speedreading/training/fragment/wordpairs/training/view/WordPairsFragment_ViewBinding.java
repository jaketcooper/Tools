...
public class WordPairsFragment_ViewBinding implements Unbinder {
    private WordPairsFragment target;

    @UiThread
    public WordPairsFragment_ViewBinding(WordPairsFragment target2, View source) {
        this.target = target2;
        ...
        target2.gridLayout = (GridLayout) Utils.findRequiredViewAsType(source, R.id.word_pairs_grid_layout, "field 'gridLayout'", GridLayout.class);
    ...
    @CallSuper
    public void unbind() {
        WordPairsFragment target2 = this.target;
        if (target2 == null) {
