...
public class GreenDotResultFragment_ViewBinding implements Unbinder {
    ...
    @UiThread
    public GreenDotResultFragment_ViewBinding(GreenDotResultFragment target2, View source) {
        this.target = target2;
        ...
        target2.lineChart = (LineChart) Utils.findRequiredViewAsType(source, R.id.green_dot_result_line_chart_view, "field 'lineChart'", LineChart.class);
    ...
    @CallSuper
    public void unbind() {
        GreenDotResultFragment target2 = this.target;
        if (target2 == null) {
