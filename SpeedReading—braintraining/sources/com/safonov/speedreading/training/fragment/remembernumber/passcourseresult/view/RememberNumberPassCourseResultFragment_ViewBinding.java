...
public class RememberNumberPassCourseResultFragment_ViewBinding implements Unbinder {
    private RememberNumberPassCourseResultFragment target;
    private View view2131296542;

    @UiThread
    public RememberNumberPassCourseResultFragment_ViewBinding(final RememberNumberPassCourseResultFragment target2, View source) {
        this.target = target2;
    ...
    @CallSuper
    public void unbind() {
        RememberNumberPassCourseResultFragment target2 = this.target;
        if (target2 == null) {
