...
public class RememberNumberResultFragment_ViewBinding implements Unbinder {
    private RememberNumberResultFragment target;

    @UiThread
    public RememberNumberResultFragment_ViewBinding(RememberNumberResultFragment target2, View source) {
        this.target = target2;
        ...
        target2.lineChart = (LineChart) Utils.findRequiredViewAsType(source, R.id.remember_number_result_line_chart, "field 'lineChart'", LineChart.class);
    ...
    @CallSuper
    public void unbind() {
        RememberNumberResultFragment target2 = this.target;
        if (target2 == null) {
