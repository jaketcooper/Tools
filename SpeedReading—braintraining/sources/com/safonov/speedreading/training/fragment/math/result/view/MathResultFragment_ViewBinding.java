...
public class MathResultFragment_ViewBinding implements Unbinder {
    ...
    @UiThread
    public MathResultFragment_ViewBinding(MathResultFragment target2, View source) {
        this.target = target2;
        target2.scoreTextView = (TextView) Utils.findRequiredViewAsType(source, R.id.math_score_text_view, "field 'scoreTextView'", TextView.class);
        target2.bestScoreTextView = (TextView) Utils.findRequiredViewAsType(source, R.id.math_best_score_text_view, "field 'bestScoreTextView'", TextView.class);
        target2.newBestScoreView = (ImageView) Utils.findRequiredViewAsType(source, R.id.new_math_best_score_image_view, "field 'newBestScoreView'", ImageView.class);
        target2.lineChart = (LineChart) Utils.findRequiredViewAsType(source, R.id.math_result_line_chart, "field 'lineChart'", LineChart.class);
    ...
    @CallSuper
    public void unbind() {
        MathResultFragment target2 = this.target;
        if (target2 == null) {
