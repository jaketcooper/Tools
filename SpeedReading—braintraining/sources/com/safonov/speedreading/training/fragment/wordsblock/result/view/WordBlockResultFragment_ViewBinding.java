...
public class WordBlockResultFragment_ViewBinding implements Unbinder {
    private WordBlockResultFragment target;

    @UiThread
    public WordBlockResultFragment_ViewBinding(WordBlockResultFragment target2, View source) {
        this.target = target2;
    ...
    @CallSuper
    public void unbind() {
        WordBlockResultFragment target2 = this.target;
        if (target2 == null) {
