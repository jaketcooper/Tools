...
public class WordBlockPassCourseResultFragment_ViewBinding implements Unbinder {
    private WordBlockPassCourseResultFragment target;
    private View view2131296542;

    @UiThread
    public WordBlockPassCourseResultFragment_ViewBinding(final WordBlockPassCourseResultFragment target2, View source) {
        this.target = target2;
    ...
    @CallSuper
    public void unbind() {
        WordBlockPassCourseResultFragment target2 = this.target;
        if (target2 == null) {
