...
public class FlashWordsResultFragment_ViewBinding implements Unbinder {
    private FlashWordsResultFragment target;

    @UiThread
    public FlashWordsResultFragment_ViewBinding(FlashWordsResultFragment target2, View source) {
        this.target = target2;
    ...
    @CallSuper
    public void unbind() {
        FlashWordsResultFragment target2 = this.target;
        if (target2 == null) {
