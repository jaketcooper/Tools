...
public class WordColumnsCourseResultFragment_ViewBinding implements Unbinder {
    ...
    @UiThread
    public WordColumnsCourseResultFragment_ViewBinding(final WordColumnsCourseResultFragment target2, View source) {
        this.target = target2;
    ...
    @CallSuper
    public void unbind() {
        WordColumnsCourseResultFragment target2 = this.target;
        if (target2 == null) {
