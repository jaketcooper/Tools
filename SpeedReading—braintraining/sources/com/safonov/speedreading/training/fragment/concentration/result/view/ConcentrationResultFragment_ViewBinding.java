...
public class ConcentrationResultFragment_ViewBinding implements Unbinder {
    ...
    @UiThread
    public ConcentrationResultFragment_ViewBinding(ConcentrationResultFragment target2, View source) {
        this.target = target2;
        ...
        target2.bestScoreTextView = (TextView) Utils.findRequiredViewAsType(source, R.id.concentration_best_score_text_view, "field 'bestScoreTextView'", TextView.class);
        target2.newBestScoreView = (ImageView) Utils.findRequiredViewAsType(source, R.id.new_concentration_best_score_image_view, "field 'newBestScoreView'", ImageView.class);
        target2.lineChart = (LineChart) Utils.findRequiredViewAsType(source, R.id.concentration_result_line_chart, "field 'lineChart'", LineChart.class);
    ...
    @CallSuper
    public void unbind() {
        ConcentrationResultFragment target2 = this.target;
        if (target2 == null) {
