...
/* renamed from: io.realm.MathConfigRealmProxy */
public class MathConfigRealmProxy extends MathConfig implements RealmObjectProxy, MathConfigRealmProxyInterface {
    ...
    /* renamed from: io.realm.MathConfigRealmProxy$MathConfigColumnInfo */
    static final class MathConfigColumnInfo extends ColumnInfo implements Cloneable {
        public long complexityIndex;
        public long durationIndex;
        public long idIndex;

        MathConfigColumnInfo(String path, Table table) {
            Map<String, Long> indicesMap = new HashMap<>(3);
            this.idIndex = getValidColumnIndex(path, table, "MathConfig", IdentityRealmObject.FIELD_ID);
            indicesMap.put(IdentityRealmObject.FIELD_ID, Long.valueOf(this.idIndex));
            this.complexityIndex = getValidColumnIndex(path, table, "MathConfig", "complexity");
            indicesMap.put("complexity", Long.valueOf(this.complexityIndex));
            this.durationIndex = getValidColumnIndex(path, table, "MathConfig", "duration");
            indicesMap.put("duration", Long.valueOf(this.durationIndex));
            setIndicesMap(indicesMap);
        }

        public final void copyColumnInfoFrom(ColumnInfo other) {
            MathConfigColumnInfo otherInfo = (MathConfigColumnInfo) other;
        ...
        public final MathConfigColumnInfo clone() {
            return (MathConfigColumnInfo) super.clone();
        }
    }
    ...
    public void realm$injectObjectContext() {
        if (this.proxyState == null) {
            ...
            this.columnInfo = (MathConfigColumnInfo) context.getColumnInfo();
    ...
    public static RealmObjectSchema createRealmObjectSchema(RealmSchema realmSchema) {
        ...
        RealmObjectSchema realmObjectSchema = realmSchema.create("MathConfig");
    ...
    public static Table initTable(SharedRealm sharedRealm) {
        if (sharedRealm.hasTable("class_MathConfig")) {
            return sharedRealm.getTable("class_MathConfig");
        }
    ...
    public static MathConfigColumnInfo validateTable(SharedRealm sharedRealm, boolean allowExtraColumns) {
        if (sharedRealm.hasTable("class_MathConfig")) {
            Table table = sharedRealm.getTable("class_MathConfig");
            ...
            MathConfigColumnInfo columnInfo2 = new MathConfigColumnInfo(sharedRealm.getPath(), table);
    ...
    public static MathConfig createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update) throws JSONException {
        ...
        if (update) {
            ...
            if (rowIndex != -1) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.schema.getColumnInfo(MathConfig.class), false, Collections.emptyList());
                    obj = new MathConfigRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            if (!json.has(IdentityRealmObject.FIELD_ID)) {
                ...
                obj = (MathConfigRealmProxy) realm.createObjectInternal(MathConfig.class, (Object) null, true, emptyList);
            } else {
                obj = (MathConfigRealmProxy) realm.createObjectInternal(MathConfig.class, Integer.valueOf(json.getInt(IdentityRealmObject.FIELD_ID)), true, emptyList);
            }
        }
    ...
    @TargetApi(11)
    public static MathConfig createUsingJsonStream(Realm realm, JsonReader reader) throws IOException {
        boolean jsonHasPrimaryKey = false;
        MathConfig obj = new MathConfig();
        reader.beginObject();
        ...
        if (jsonHasPrimaryKey) {
            return (MathConfig) realm.copyToRealm(obj);
        }
        throw new IllegalArgumentException("JSON object doesn't have the primary key field 'id'.");
    }

    public static MathConfig copyOrUpdate(Realm realm, MathConfig object, boolean update, Map<RealmModel, RealmObjectProxy> cache) {
        if ((object instanceof RealmObjectProxy) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().threadId != realm.threadId) {
            ...
            if (cachedRealmObject != null) {
                return (MathConfig) cachedRealmObject;
            }
            MathConfig realmObject = null;
            ...
            if (canUpdate) {
                ...
                if (rowIndex != -1) {
                    try {
                        objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.schema.getColumnInfo(MathConfig.class), false, Collections.emptyList());
                        MathConfig realmObject2 = new MathConfigRealmProxy();
                        try {
                            ...
                            th = th;
                            MathConfig mathConfig = realmObject2;
                            objectContext.clear();
                            throw th;
                        }
                    } catch (Throwable th2) {
    ...
    public static MathConfig copy(Realm realm, MathConfig newObject, boolean update, Map<RealmModel, RealmObjectProxy> cache) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (MathConfig) cachedRealmObject;
        }
        MathConfig realmObject = (MathConfig) realm.createObjectInternal(MathConfig.class, Integer.valueOf(newObject.realmGet$id()), false, Collections.emptyList());
    ...
    public static long insert(Realm realm, MathConfig object, Map<RealmModel, Long> cache) {
        if ((object instanceof RealmObjectProxy) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(MathConfig.class);
        long tableNativePtr = table.getNativeTablePointer();
        MathConfigColumnInfo columnInfo2 = (MathConfigColumnInfo) realm.schema.getColumnInfo(MathConfig.class);
        long pkColumnIndex = table.getPrimaryKey();
        long rowIndex = -1;
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel, Long> cache) {
        ...
        while (objects.hasNext()) {
            MathConfig object = (MathConfig) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, MathConfig object, Map<RealmModel, Long> cache) {
        if ((object instanceof RealmObjectProxy) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(MathConfig.class);
    ...
    public static MathConfig createDetachedCopy(MathConfig realmObject, int currentDepth, int maxDepth, Map<RealmModel, RealmObjectProxy.CacheData<RealmModel>> cache) {
        MathConfig unmanagedObject;
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        RealmObjectProxy.CacheData<RealmModel> cachedObject = cache.get(realmObject);
        if (cachedObject == null) {
            unmanagedObject = new MathConfig();
            cache.put(realmObject, new RealmObjectProxy.CacheData(currentDepth, unmanagedObject));
        } else if (currentDepth >= cachedObject.minDepth) {
            return (MathConfig) cachedObject.object;
        } else {
            unmanagedObject = (MathConfig) cachedObject.object;
    ...
    static MathConfig update(Realm realm, MathConfig realmObject, MathConfig newObject, Map<RealmModel, RealmObjectProxy> map) {
        realmObject.realmSet$complexity(newObject.realmGet$complexity());
        realmObject.realmSet$duration(newObject.realmGet$duration());
        return realmObject;
    }
    ...
    public String toString() {
        ...
        return "MathConfig = [" + "{id:" + realmGet$id() + "}" + "," + "{complexity:" + realmGet$complexity() + "}" + "," + "{duration:" + realmGet$duration() + "}" + "]";
    }
    ...
    public boolean equals(Object o) {
        ...
        MathConfigRealmProxy aMathConfig = (MathConfigRealmProxy) o;
        String path = this.proxyState.getRealm$realm().getPath();
        String otherPath = aMathConfig.proxyState.getRealm$realm().getPath();
        if (path == null ? otherPath != null : !path.equals(otherPath)) {
            return false;
        }
        String tableName = this.proxyState.getRow$realm().getTable().getName();
        String otherTableName = aMathConfig.proxyState.getRow$realm().getTable().getName();
        if (tableName == null ? otherTableName != null : !tableName.equals(otherTableName)) {
            return false;
        }
        if (this.proxyState.getRow$realm().getIndex() != aMathConfig.proxyState.getRow$realm().getIndex()) {
            return false;
        }
        return true;
    }
