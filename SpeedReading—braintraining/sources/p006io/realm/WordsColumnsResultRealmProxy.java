...
/* renamed from: io.realm.WordsColumnsResultRealmProxy */
public class WordsColumnsResultRealmProxy extends WordsColumnsResult implements RealmObjectProxy, WordsColumnsResultRealmProxyInterface {
    ...
    /* renamed from: io.realm.WordsColumnsResultRealmProxy$WordsColumnsResultColumnInfo */
    static final class WordsColumnsResultColumnInfo extends ColumnInfo implements Cloneable {
        public long configIndex;
        public long idIndex;
        public long unixTimeIndex;

        WordsColumnsResultColumnInfo(String path, Table table) {
            Map<String, Long> indicesMap = new HashMap<>(3);
            this.idIndex = getValidColumnIndex(path, table, "WordsColumnsResult", IdentityRealmObject.FIELD_ID);
            indicesMap.put(IdentityRealmObject.FIELD_ID, Long.valueOf(this.idIndex));
            this.unixTimeIndex = getValidColumnIndex(path, table, "WordsColumnsResult", UnixTimeRealmObject.FIELD_UNIX_TIME);
            indicesMap.put(UnixTimeRealmObject.FIELD_UNIX_TIME, Long.valueOf(this.unixTimeIndex));
            this.configIndex = getValidColumnIndex(path, table, "WordsColumnsResult", "config");
            indicesMap.put("config", Long.valueOf(this.configIndex));
            setIndicesMap(indicesMap);
        }

        public final void copyColumnInfoFrom(ColumnInfo other) {
            WordsColumnsResultColumnInfo otherInfo = (WordsColumnsResultColumnInfo) other;
        ...
        public final WordsColumnsResultColumnInfo clone() {
            return (WordsColumnsResultColumnInfo) super.clone();
        }
    }
    ...
    public void realm$injectObjectContext() {
        if (this.proxyState == null) {
            ...
            this.columnInfo = (WordsColumnsResultColumnInfo) context.getColumnInfo();
    ...
    public void realmSet$config(WordsColumnsConfig value) {
        if (!this.proxyState.isUnderConstruction()) {
            this.proxyState.getRealm$realm().checkIfValid();
            if (value == null) {
            ...
            if (value != null && !RealmObject.isManaged(value)) {
                value = (WordsColumnsConfig) ((Realm) this.proxyState.getRealm$realm()).copyToRealm(value);
            }
            Row row = this.proxyState.getRow$realm();
            if (value == null) {
    ...
    public static RealmObjectSchema createRealmObjectSchema(RealmSchema realmSchema) {
        ...
        RealmObjectSchema realmObjectSchema = realmSchema.create("WordsColumnsResult");
        ...
        realmObjectSchema.add(new Property("config", RealmFieldType.OBJECT, realmSchema.get("WordsColumnsConfig")));
    ...
    public static WordsColumnsResultColumnInfo validateTable(SharedRealm sharedRealm, boolean allowExtraColumns) {
        if (sharedRealm.hasTable("class_WordsColumnsResult")) {
            Table table = sharedRealm.getTable("class_WordsColumnsResult");
            ...
            WordsColumnsResultColumnInfo columnInfo2 = new WordsColumnsResultColumnInfo(sharedRealm.getPath(), table);
    ...
    public static WordsColumnsResult createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update) throws JSONException {
        ArrayList arrayList = new ArrayList(1);
        WordsColumnsResult obj = null;
        if (update) {
            ...
            if (rowIndex != -1) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.schema.getColumnInfo(WordsColumnsResult.class), false, Collections.emptyList());
                    obj = new WordsColumnsResultRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            ...
            if (!json.has(IdentityRealmObject.FIELD_ID)) {
                ...
                obj = (WordsColumnsResultRealmProxy) realm.createObjectInternal(WordsColumnsResult.class, (Object) null, true, arrayList);
            } else {
                obj = (WordsColumnsResultRealmProxy) realm.createObjectInternal(WordsColumnsResult.class, Integer.valueOf(json.getInt(IdentityRealmObject.FIELD_ID)), true, arrayList);
            }
        }
        ...
        if (json.has("config")) {
            if (json.isNull("config")) {
                obj.realmSet$config((WordsColumnsConfig) null);
            } else {
                obj.realmSet$config(WordsColumnsConfigRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("config"), update));
            }
        }
        return obj;
    }
    ...
    @TargetApi(11)
    public static WordsColumnsResult createUsingJsonStream(Realm realm, JsonReader reader) throws IOException {
        boolean jsonHasPrimaryKey = false;
        WordsColumnsResult obj = new WordsColumnsResult();
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (name.equals(IdentityRealmObject.FIELD_ID)) {
                ...
                obj.realmSet$config(WordsColumnsConfigRealmProxy.createUsingJsonStream(realm, reader));
            }
        }
        reader.endObject();
        if (jsonHasPrimaryKey) {
            return (WordsColumnsResult) realm.copyToRealm(obj);
        }
        throw new IllegalArgumentException("JSON object doesn't have the primary key field 'id'.");
    }

    public static WordsColumnsResult copyOrUpdate(Realm realm, WordsColumnsResult object, boolean update, Map<RealmModel, RealmObjectProxy> cache) {
        if ((object instanceof RealmObjectProxy) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().threadId != realm.threadId) {
            ...
            if (cachedRealmObject != null) {
                return (WordsColumnsResult) cachedRealmObject;
            }
            WordsColumnsResult realmObject = null;
            ...
            if (canUpdate) {
                ...
                if (rowIndex != -1) {
                    try {
                        objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.schema.getColumnInfo(WordsColumnsResult.class), false, Collections.emptyList());
                        WordsColumnsResult realmObject2 = new WordsColumnsResultRealmProxy();
                        try {
                            ...
                            th = th;
                            WordsColumnsResult wordsColumnsResult = realmObject2;
                            objectContext.clear();
                            throw th;
                        }
                    } catch (Throwable th2) {
    ...
    public static WordsColumnsResult copy(Realm realm, WordsColumnsResult newObject, boolean update, Map<RealmModel, RealmObjectProxy> cache) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (WordsColumnsResult) cachedRealmObject;
        }
        WordsColumnsResult realmObject = (WordsColumnsResult) realm.createObjectInternal(WordsColumnsResult.class, Integer.valueOf(newObject.realmGet$id()), false, Collections.emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);
        realmObject.realmSet$unixTime(newObject.realmGet$unixTime());
        WordsColumnsConfig configObj = newObject.realmGet$config();
        if (configObj != null) {
            WordsColumnsConfig cacheconfig = (WordsColumnsConfig) cache.get(configObj);
            if (cacheconfig != null) {
                realmObject.realmSet$config(cacheconfig);
            } else {
                realmObject.realmSet$config(WordsColumnsConfigRealmProxy.copyOrUpdate(realm, configObj, update, cache));
            }
        } else {
            realmObject.realmSet$config((WordsColumnsConfig) null);
        }
        return realmObject;
    }

    public static long insert(Realm realm, WordsColumnsResult object, Map<RealmModel, Long> cache) {
        if ((object instanceof RealmObjectProxy) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(WordsColumnsResult.class);
        long tableNativePtr = table.getNativeTablePointer();
        WordsColumnsResultColumnInfo columnInfo2 = (WordsColumnsResultColumnInfo) realm.schema.getColumnInfo(WordsColumnsResult.class);
        long pkColumnIndex = table.getPrimaryKey();
        long rowIndex = -1;
        ...
        WordsColumnsConfig configObj = object.realmGet$config();
        if (configObj == null) {
            return rowIndex;
        }
        Long cacheconfig = cache.get(configObj);
        if (cacheconfig == null) {
            cacheconfig = Long.valueOf(WordsColumnsConfigRealmProxy.insert(realm, configObj, cache));
        }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel, Long> cache) {
        ...
        while (objects.hasNext()) {
            WordsColumnsResult object = (WordsColumnsResult) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, WordsColumnsResult object, Map<RealmModel, Long> cache) {
        if ((object instanceof RealmObjectProxy) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(WordsColumnsResult.class);
        ...
        if (configObj != null) {
            Long cacheconfig = cache.get(configObj);
            if (cacheconfig == null) {
                cacheconfig = Long.valueOf(WordsColumnsConfigRealmProxy.insertOrUpdate(realm, configObj, cache));
            }
            Table.nativeSetLink(tableNativePtr, columnInfo2.configIndex, rowIndex, cacheconfig.longValue(), false);
            return rowIndex;
        }
    ...
    public static WordsColumnsResult createDetachedCopy(WordsColumnsResult realmObject, int currentDepth, int maxDepth, Map<RealmModel, RealmObjectProxy.CacheData<RealmModel>> cache) {
        WordsColumnsResult unmanagedObject;
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        RealmObjectProxy.CacheData<RealmModel> cachedObject = cache.get(realmObject);
        if (cachedObject == null) {
            unmanagedObject = new WordsColumnsResult();
            cache.put(realmObject, new RealmObjectProxy.CacheData(currentDepth, unmanagedObject));
        } else if (currentDepth >= cachedObject.minDepth) {
            return (WordsColumnsResult) cachedObject.object;
        } else {
            unmanagedObject = (WordsColumnsResult) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        unmanagedObject.realmSet$id(realmObject.realmGet$id());
        unmanagedObject.realmSet$unixTime(realmObject.realmGet$unixTime());
        unmanagedObject.realmSet$config(WordsColumnsConfigRealmProxy.createDetachedCopy(realmObject.realmGet$config(), currentDepth + 1, maxDepth, cache));
        return unmanagedObject;
    }

    static WordsColumnsResult update(Realm realm, WordsColumnsResult realmObject, WordsColumnsResult newObject, Map<RealmModel, RealmObjectProxy> cache) {
        realmObject.realmSet$unixTime(newObject.realmGet$unixTime());
        WordsColumnsConfig configObj = newObject.realmGet$config();
        if (configObj != null) {
            WordsColumnsConfig cacheconfig = (WordsColumnsConfig) cache.get(configObj);
            if (cacheconfig != null) {
                ...
                realmObject.realmSet$config(WordsColumnsConfigRealmProxy.copyOrUpdate(realm, configObj, true, cache));
            }
        } else {
            realmObject.realmSet$config((WordsColumnsConfig) null);
        }
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("WordsColumnsResult = [");
        ...
        stringBuilder.append(realmGet$config() != null ? "WordsColumnsConfig" : "null");
        stringBuilder.append("}");
        stringBuilder.append("]");
    ...
    public boolean equals(Object o) {
        ...
        WordsColumnsResultRealmProxy aWordsColumnsResult = (WordsColumnsResultRealmProxy) o;
        String path = this.proxyState.getRealm$realm().getPath();
        String otherPath = aWordsColumnsResult.proxyState.getRealm$realm().getPath();
        if (path == null ? otherPath != null : !path.equals(otherPath)) {
            return false;
        }
        String tableName = this.proxyState.getRow$realm().getTable().getName();
        String otherTableName = aWordsColumnsResult.proxyState.getRow$realm().getTable().getName();
        if (tableName == null ? otherTableName != null : !tableName.equals(otherTableName)) {
            return false;
        }
        if (this.proxyState.getRow$realm().getIndex() != aWordsColumnsResult.proxyState.getRow$realm().getIndex()) {
            return false;
        }
        return true;
    }
