...
/* renamed from: io.realm.FlashWordResultRealmProxy */
public class FlashWordResultRealmProxy extends FlashWordResult implements RealmObjectProxy, FlashWordResultRealmProxyInterface {
    private static final List<String> FIELD_NAMES;
    private FlashWordResultColumnInfo columnInfo;
    private ProxyState<FlashWordResult> proxyState;

    /* renamed from: io.realm.FlashWordResultRealmProxy$FlashWordResultColumnInfo */
    static final class FlashWordResultColumnInfo extends ColumnInfo implements Cloneable {
        public long configIndex;
        public long idIndex;
        public long unixTimeIndex;

        FlashWordResultColumnInfo(String path, Table table) {
            Map<String, Long> indicesMap = new HashMap<>(3);
            this.idIndex = getValidColumnIndex(path, table, "FlashWordResult", IdentityRealmObject.FIELD_ID);
            indicesMap.put(IdentityRealmObject.FIELD_ID, Long.valueOf(this.idIndex));
            this.unixTimeIndex = getValidColumnIndex(path, table, "FlashWordResult", UnixTimeRealmObject.FIELD_UNIX_TIME);
            indicesMap.put(UnixTimeRealmObject.FIELD_UNIX_TIME, Long.valueOf(this.unixTimeIndex));
            this.configIndex = getValidColumnIndex(path, table, "FlashWordResult", "config");
            indicesMap.put("config", Long.valueOf(this.configIndex));
            setIndicesMap(indicesMap);
        }

        public final void copyColumnInfoFrom(ColumnInfo other) {
            FlashWordResultColumnInfo otherInfo = (FlashWordResultColumnInfo) other;
        ...
        public final FlashWordResultColumnInfo clone() {
            return (FlashWordResultColumnInfo) super.clone();
        }
    }
    ...
    public void realm$injectObjectContext() {
        if (this.proxyState == null) {
            ...
            this.columnInfo = (FlashWordResultColumnInfo) context.getColumnInfo();
    ...
    public FlashWordsConfig realmGet$config() {
        ...
        return (FlashWordsConfig) this.proxyState.getRealm$realm().get(FlashWordsConfig.class, this.proxyState.getRow$realm().getLink(this.columnInfo.configIndex), false, Collections.emptyList());
    }

    public void realmSet$config(FlashWordsConfig value) {
        if (!this.proxyState.isUnderConstruction()) {
            this.proxyState.getRealm$realm().checkIfValid();
            if (value == null) {
            ...
            if (value != null && !RealmObject.isManaged(value)) {
                value = (FlashWordsConfig) ((Realm) this.proxyState.getRealm$realm()).copyToRealm(value);
            }
            Row row = this.proxyState.getRow$realm();
            if (value == null) {
    ...
    public static RealmObjectSchema createRealmObjectSchema(RealmSchema realmSchema) {
        if (realmSchema.contains("FlashWordResult")) {
            return realmSchema.get("FlashWordResult");
        }
        RealmObjectSchema realmObjectSchema = realmSchema.create("FlashWordResult");
        ...
        if (!realmSchema.contains("FlashWordsConfig")) {
            FlashWordsConfigRealmProxy.createRealmObjectSchema(realmSchema);
        }
        realmObjectSchema.add(new Property("config", RealmFieldType.OBJECT, realmSchema.get("FlashWordsConfig")));
        return realmObjectSchema;
    }

    public static Table initTable(SharedRealm sharedRealm) {
        if (sharedRealm.hasTable("class_FlashWordResult")) {
            return sharedRealm.getTable("class_FlashWordResult");
        }
        Table table = sharedRealm.getTable("class_FlashWordResult");
        ...
        if (!sharedRealm.hasTable("class_FlashWordsConfig")) {
            FlashWordsConfigRealmProxy.initTable(sharedRealm);
        }
        table.addColumnLink(RealmFieldType.OBJECT, "config", sharedRealm.getTable("class_FlashWordsConfig"));
        table.addSearchIndex(table.getColumnIndex(IdentityRealmObject.FIELD_ID));
        table.setPrimaryKey(IdentityRealmObject.FIELD_ID);
        return table;
    }

    public static FlashWordResultColumnInfo validateTable(SharedRealm sharedRealm, boolean allowExtraColumns) {
        if (sharedRealm.hasTable("class_FlashWordResult")) {
            Table table = sharedRealm.getTable("class_FlashWordResult");
            ...
            FlashWordResultColumnInfo columnInfo2 = new FlashWordResultColumnInfo(sharedRealm.getPath(), table);
            if (!table.hasPrimaryKey()) {
                ...
                throw new RealmMigrationNeededException(sharedRealm.getPath(), "Invalid type 'FlashWordsConfig' for field 'config'");
            } else if (!sharedRealm.hasTable("class_FlashWordsConfig")) {
                throw new RealmMigrationNeededException(sharedRealm.getPath(), "Missing class 'class_FlashWordsConfig' for field 'config'");
            } else {
                Table table_2 = sharedRealm.getTable("class_FlashWordsConfig");
            ...
            throw new RealmMigrationNeededException(sharedRealm.getPath(), "The 'FlashWordResult' class is missing from the schema for this Realm.");
        }
    }

    public static String getTableName() {
        return "class_FlashWordResult";
    }
    ...
    public static FlashWordResult createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update) throws JSONException {
        ArrayList arrayList = new ArrayList(1);
        FlashWordResult obj = null;
        if (update) {
            Table table = realm.getTable(FlashWordResult.class);
            ...
            if (rowIndex != -1) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.schema.getColumnInfo(FlashWordResult.class), false, Collections.emptyList());
                    obj = new FlashWordResultRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            ...
            if (!json.has(IdentityRealmObject.FIELD_ID)) {
                ...
                obj = (FlashWordResultRealmProxy) realm.createObjectInternal(FlashWordResult.class, (Object) null, true, arrayList);
            } else {
                obj = (FlashWordResultRealmProxy) realm.createObjectInternal(FlashWordResult.class, Integer.valueOf(json.getInt(IdentityRealmObject.FIELD_ID)), true, arrayList);
            }
        }
        ...
        if (json.has("config")) {
            if (json.isNull("config")) {
                obj.realmSet$config((FlashWordsConfig) null);
            } else {
                obj.realmSet$config(FlashWordsConfigRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("config"), update));
            }
        }
        return obj;
    }
    ...
    @TargetApi(11)
    public static FlashWordResult createUsingJsonStream(Realm realm, JsonReader reader) throws IOException {
        boolean jsonHasPrimaryKey = false;
        FlashWordResult obj = new FlashWordResult();
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (name.equals(IdentityRealmObject.FIELD_ID)) {
                ...
                obj.realmSet$config(FlashWordsConfigRealmProxy.createUsingJsonStream(realm, reader));
            }
        }
        reader.endObject();
        if (jsonHasPrimaryKey) {
            return (FlashWordResult) realm.copyToRealm(obj);
        }
        throw new IllegalArgumentException("JSON object doesn't have the primary key field 'id'.");
    }

    public static FlashWordResult copyOrUpdate(Realm realm, FlashWordResult object, boolean update, Map<RealmModel, RealmObjectProxy> cache) {
        if ((object instanceof RealmObjectProxy) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().threadId != realm.threadId) {
            ...
            if (cachedRealmObject != null) {
                return (FlashWordResult) cachedRealmObject;
            }
            FlashWordResult realmObject = null;
            ...
            if (canUpdate) {
                ...
                if (rowIndex != -1) {
                    try {
                        objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.schema.getColumnInfo(FlashWordResult.class), false, Collections.emptyList());
                        FlashWordResult realmObject2 = new FlashWordResultRealmProxy();
                        try {
                            ...
                            th = th;
                            FlashWordResult flashWordResult = realmObject2;
                            objectContext.clear();
                            throw th;
                        }
                    } catch (Throwable th2) {
    ...
    public static FlashWordResult copy(Realm realm, FlashWordResult newObject, boolean update, Map<RealmModel, RealmObjectProxy> cache) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (FlashWordResult) cachedRealmObject;
        }
        FlashWordResult realmObject = (FlashWordResult) realm.createObjectInternal(FlashWordResult.class, Integer.valueOf(newObject.realmGet$id()), false, Collections.emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);
        realmObject.realmSet$unixTime(newObject.realmGet$unixTime());
        FlashWordsConfig configObj = newObject.realmGet$config();
        if (configObj != null) {
            FlashWordsConfig cacheconfig = (FlashWordsConfig) cache.get(configObj);
            if (cacheconfig != null) {
                realmObject.realmSet$config(cacheconfig);
            } else {
                realmObject.realmSet$config(FlashWordsConfigRealmProxy.copyOrUpdate(realm, configObj, update, cache));
            }
        } else {
            realmObject.realmSet$config((FlashWordsConfig) null);
        }
        return realmObject;
    }

    public static long insert(Realm realm, FlashWordResult object, Map<RealmModel, Long> cache) {
        if ((object instanceof RealmObjectProxy) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(FlashWordResult.class);
        long tableNativePtr = table.getNativeTablePointer();
        FlashWordResultColumnInfo columnInfo2 = (FlashWordResultColumnInfo) realm.schema.getColumnInfo(FlashWordResult.class);
        long pkColumnIndex = table.getPrimaryKey();
        long rowIndex = -1;
        ...
        FlashWordsConfig configObj = object.realmGet$config();
        if (configObj == null) {
            return rowIndex;
        }
        Long cacheconfig = cache.get(configObj);
        if (cacheconfig == null) {
            cacheconfig = Long.valueOf(FlashWordsConfigRealmProxy.insert(realm, configObj, cache));
        }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel, Long> cache) {
        ...
        while (objects.hasNext()) {
            FlashWordResult object = (FlashWordResult) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, FlashWordResult object, Map<RealmModel, Long> cache) {
        if ((object instanceof RealmObjectProxy) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(FlashWordResult.class);
        ...
        if (configObj != null) {
            Long cacheconfig = cache.get(configObj);
            if (cacheconfig == null) {
                cacheconfig = Long.valueOf(FlashWordsConfigRealmProxy.insertOrUpdate(realm, configObj, cache));
            }
            Table.nativeSetLink(tableNativePtr, columnInfo2.configIndex, rowIndex, cacheconfig.longValue(), false);
            return rowIndex;
        }
    ...
    public static FlashWordResult createDetachedCopy(FlashWordResult realmObject, int currentDepth, int maxDepth, Map<RealmModel, RealmObjectProxy.CacheData<RealmModel>> cache) {
        FlashWordResult unmanagedObject;
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        RealmObjectProxy.CacheData<RealmModel> cachedObject = cache.get(realmObject);
        if (cachedObject == null) {
            unmanagedObject = new FlashWordResult();
            cache.put(realmObject, new RealmObjectProxy.CacheData(currentDepth, unmanagedObject));
        } else if (currentDepth >= cachedObject.minDepth) {
            return (FlashWordResult) cachedObject.object;
        } else {
            unmanagedObject = (FlashWordResult) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        unmanagedObject.realmSet$id(realmObject.realmGet$id());
        unmanagedObject.realmSet$unixTime(realmObject.realmGet$unixTime());
        unmanagedObject.realmSet$config(FlashWordsConfigRealmProxy.createDetachedCopy(realmObject.realmGet$config(), currentDepth + 1, maxDepth, cache));
        return unmanagedObject;
    }

    static FlashWordResult update(Realm realm, FlashWordResult realmObject, FlashWordResult newObject, Map<RealmModel, RealmObjectProxy> cache) {
        realmObject.realmSet$unixTime(newObject.realmGet$unixTime());
        FlashWordsConfig configObj = newObject.realmGet$config();
        if (configObj != null) {
            FlashWordsConfig cacheconfig = (FlashWordsConfig) cache.get(configObj);
            if (cacheconfig != null) {
                ...
                realmObject.realmSet$config(FlashWordsConfigRealmProxy.copyOrUpdate(realm, configObj, true, cache));
            }
        } else {
            realmObject.realmSet$config((FlashWordsConfig) null);
        }
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("FlashWordResult = [");
        ...
        stringBuilder.append(realmGet$config() != null ? "FlashWordsConfig" : "null");
        stringBuilder.append("}");
        stringBuilder.append("]");
    ...
    public boolean equals(Object o) {
        ...
        FlashWordResultRealmProxy aFlashWordResult = (FlashWordResultRealmProxy) o;
        String path = this.proxyState.getRealm$realm().getPath();
        String otherPath = aFlashWordResult.proxyState.getRealm$realm().getPath();
        if (path == null ? otherPath != null : !path.equals(otherPath)) {
            return false;
        }
        String tableName = this.proxyState.getRow$realm().getTable().getName();
        String otherTableName = aFlashWordResult.proxyState.getRow$realm().getTable().getName();
        if (tableName == null ? otherTableName != null : !tableName.equals(otherTableName)) {
            return false;
        }
        if (this.proxyState.getRow$realm().getIndex() != aFlashWordResult.proxyState.getRow$realm().getIndex()) {
            return false;
        }
        return true;
    }
