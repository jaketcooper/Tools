...
/* renamed from: io.realm.EvenNumbersResultRealmProxy */
public class EvenNumbersResultRealmProxy extends EvenNumbersResult implements RealmObjectProxy, EvenNumbersResultRealmProxyInterface {
    private static final List<String> FIELD_NAMES;
    private EvenNumbersResultColumnInfo columnInfo;
    private ProxyState<EvenNumbersResult> proxyState;

    /* renamed from: io.realm.EvenNumbersResultRealmProxy$EvenNumbersResultColumnInfo */
    static final class EvenNumbersResultColumnInfo extends ColumnInfo implements Cloneable {
        public long configIndex;
        public long idIndex;
        public long scoreIndex;
        public long unixTimeIndex;

        EvenNumbersResultColumnInfo(String path, Table table) {
            Map<String, Long> indicesMap = new HashMap<>(4);
            this.idIndex = getValidColumnIndex(path, table, "EvenNumbersResult", IdentityRealmObject.FIELD_ID);
            indicesMap.put(IdentityRealmObject.FIELD_ID, Long.valueOf(this.idIndex));
            this.scoreIndex = getValidColumnIndex(path, table, "EvenNumbersResult", "score");
            indicesMap.put("score", Long.valueOf(this.scoreIndex));
            this.unixTimeIndex = getValidColumnIndex(path, table, "EvenNumbersResult", UnixTimeRealmObject.FIELD_UNIX_TIME);
            indicesMap.put(UnixTimeRealmObject.FIELD_UNIX_TIME, Long.valueOf(this.unixTimeIndex));
            this.configIndex = getValidColumnIndex(path, table, "EvenNumbersResult", "config");
            indicesMap.put("config", Long.valueOf(this.configIndex));
            setIndicesMap(indicesMap);
        }

        public final void copyColumnInfoFrom(ColumnInfo other) {
            EvenNumbersResultColumnInfo otherInfo = (EvenNumbersResultColumnInfo) other;
        ...
        public final EvenNumbersResultColumnInfo clone() {
            return (EvenNumbersResultColumnInfo) super.clone();
        }
    }
    ...
    public void realm$injectObjectContext() {
        if (this.proxyState == null) {
            ...
            this.columnInfo = (EvenNumbersResultColumnInfo) context.getColumnInfo();
    ...
    public EvenNumbersConfig realmGet$config() {
        ...
        return (EvenNumbersConfig) this.proxyState.getRealm$realm().get(EvenNumbersConfig.class, this.proxyState.getRow$realm().getLink(this.columnInfo.configIndex), false, Collections.emptyList());
    }

    public void realmSet$config(EvenNumbersConfig value) {
        if (!this.proxyState.isUnderConstruction()) {
            this.proxyState.getRealm$realm().checkIfValid();
            if (value == null) {
            ...
            if (value != null && !RealmObject.isManaged(value)) {
                value = (EvenNumbersConfig) ((Realm) this.proxyState.getRealm$realm()).copyToRealm(value);
            }
            Row row = this.proxyState.getRow$realm();
            if (value == null) {
    ...
    public static RealmObjectSchema createRealmObjectSchema(RealmSchema realmSchema) {
        if (realmSchema.contains("EvenNumbersResult")) {
            return realmSchema.get("EvenNumbersResult");
        }
        RealmObjectSchema realmObjectSchema = realmSchema.create("EvenNumbersResult");
        ...
        if (!realmSchema.contains("EvenNumbersConfig")) {
            EvenNumbersConfigRealmProxy.createRealmObjectSchema(realmSchema);
        }
        realmObjectSchema.add(new Property("config", RealmFieldType.OBJECT, realmSchema.get("EvenNumbersConfig")));
        return realmObjectSchema;
    }

    public static Table initTable(SharedRealm sharedRealm) {
        if (sharedRealm.hasTable("class_EvenNumbersResult")) {
            return sharedRealm.getTable("class_EvenNumbersResult");
        }
        Table table = sharedRealm.getTable("class_EvenNumbersResult");
        ...
        if (!sharedRealm.hasTable("class_EvenNumbersConfig")) {
            EvenNumbersConfigRealmProxy.initTable(sharedRealm);
        }
        table.addColumnLink(RealmFieldType.OBJECT, "config", sharedRealm.getTable("class_EvenNumbersConfig"));
        table.addSearchIndex(table.getColumnIndex(IdentityRealmObject.FIELD_ID));
        table.setPrimaryKey(IdentityRealmObject.FIELD_ID);
        return table;
    }

    public static EvenNumbersResultColumnInfo validateTable(SharedRealm sharedRealm, boolean allowExtraColumns) {
        if (sharedRealm.hasTable("class_EvenNumbersResult")) {
            Table table = sharedRealm.getTable("class_EvenNumbersResult");
            ...
            EvenNumbersResultColumnInfo columnInfo2 = new EvenNumbersResultColumnInfo(sharedRealm.getPath(), table);
            if (!table.hasPrimaryKey()) {
                ...
                throw new RealmMigrationNeededException(sharedRealm.getPath(), "Invalid type 'EvenNumbersConfig' for field 'config'");
            } else if (!sharedRealm.hasTable("class_EvenNumbersConfig")) {
                throw new RealmMigrationNeededException(sharedRealm.getPath(), "Missing class 'class_EvenNumbersConfig' for field 'config'");
            } else {
                Table table_3 = sharedRealm.getTable("class_EvenNumbersConfig");
            ...
            throw new RealmMigrationNeededException(sharedRealm.getPath(), "The 'EvenNumbersResult' class is missing from the schema for this Realm.");
        }
    }

    public static String getTableName() {
        return "class_EvenNumbersResult";
    }
    ...
    public static EvenNumbersResult createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update) throws JSONException {
        ArrayList arrayList = new ArrayList(1);
        EvenNumbersResult obj = null;
        if (update) {
            Table table = realm.getTable(EvenNumbersResult.class);
            ...
            if (rowIndex != -1) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.schema.getColumnInfo(EvenNumbersResult.class), false, Collections.emptyList());
                    obj = new EvenNumbersResultRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            ...
            if (!json.has(IdentityRealmObject.FIELD_ID)) {
                ...
                obj = (EvenNumbersResultRealmProxy) realm.createObjectInternal(EvenNumbersResult.class, (Object) null, true, arrayList);
            } else {
                obj = (EvenNumbersResultRealmProxy) realm.createObjectInternal(EvenNumbersResult.class, Integer.valueOf(json.getInt(IdentityRealmObject.FIELD_ID)), true, arrayList);
            }
        }
        if (json.has("score")) {
        ...
        if (json.has("config")) {
            if (json.isNull("config")) {
                obj.realmSet$config((EvenNumbersConfig) null);
            } else {
                obj.realmSet$config(EvenNumbersConfigRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("config"), update));
            }
        }
        return obj;
    }
    ...
    @TargetApi(11)
    public static EvenNumbersResult createUsingJsonStream(Realm realm, JsonReader reader) throws IOException {
        boolean jsonHasPrimaryKey = false;
        EvenNumbersResult obj = new EvenNumbersResult();
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (name.equals(IdentityRealmObject.FIELD_ID)) {
                ...
                obj.realmSet$config(EvenNumbersConfigRealmProxy.createUsingJsonStream(realm, reader));
            }
        }
        reader.endObject();
        if (jsonHasPrimaryKey) {
            return (EvenNumbersResult) realm.copyToRealm(obj);
        }
        throw new IllegalArgumentException("JSON object doesn't have the primary key field 'id'.");
    }

    public static EvenNumbersResult copyOrUpdate(Realm realm, EvenNumbersResult object, boolean update, Map<RealmModel, RealmObjectProxy> cache) {
        if ((object instanceof RealmObjectProxy) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().threadId != realm.threadId) {
            ...
            if (cachedRealmObject != null) {
                return (EvenNumbersResult) cachedRealmObject;
            }
            EvenNumbersResult realmObject = null;
            ...
            if (canUpdate) {
                ...
                if (rowIndex != -1) {
                    try {
                        objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.schema.getColumnInfo(EvenNumbersResult.class), false, Collections.emptyList());
                        EvenNumbersResult realmObject2 = new EvenNumbersResultRealmProxy();
                        try {
                            ...
                            th = th;
                            EvenNumbersResult evenNumbersResult = realmObject2;
                            objectContext.clear();
                            throw th;
                        }
                    } catch (Throwable th2) {
    ...
    public static EvenNumbersResult copy(Realm realm, EvenNumbersResult newObject, boolean update, Map<RealmModel, RealmObjectProxy> cache) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (EvenNumbersResult) cachedRealmObject;
        }
        EvenNumbersResult realmObject = (EvenNumbersResult) realm.createObjectInternal(EvenNumbersResult.class, Integer.valueOf(newObject.realmGet$id()), false, Collections.emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);
        realmObject.realmSet$score(newObject.realmGet$score());
        realmObject.realmSet$unixTime(newObject.realmGet$unixTime());
        EvenNumbersConfig configObj = newObject.realmGet$config();
        if (configObj != null) {
            EvenNumbersConfig cacheconfig = (EvenNumbersConfig) cache.get(configObj);
            if (cacheconfig != null) {
                realmObject.realmSet$config(cacheconfig);
            } else {
                realmObject.realmSet$config(EvenNumbersConfigRealmProxy.copyOrUpdate(realm, configObj, update, cache));
            }
        } else {
            realmObject.realmSet$config((EvenNumbersConfig) null);
        }
        return realmObject;
    }

    public static long insert(Realm realm, EvenNumbersResult object, Map<RealmModel, Long> cache) {
        if ((object instanceof RealmObjectProxy) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(EvenNumbersResult.class);
        long tableNativePtr = table.getNativeTablePointer();
        EvenNumbersResultColumnInfo columnInfo2 = (EvenNumbersResultColumnInfo) realm.schema.getColumnInfo(EvenNumbersResult.class);
        long pkColumnIndex = table.getPrimaryKey();
        long rowIndex = -1;
        ...
        EvenNumbersConfig configObj = object.realmGet$config();
        if (configObj == null) {
            return rowIndex;
        }
        Long cacheconfig = cache.get(configObj);
        if (cacheconfig == null) {
            cacheconfig = Long.valueOf(EvenNumbersConfigRealmProxy.insert(realm, configObj, cache));
        }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel, Long> cache) {
        ...
        while (objects.hasNext()) {
            EvenNumbersResult object = (EvenNumbersResult) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, EvenNumbersResult object, Map<RealmModel, Long> cache) {
        if ((object instanceof RealmObjectProxy) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(EvenNumbersResult.class);
        ...
        if (configObj != null) {
            Long cacheconfig = cache.get(configObj);
            if (cacheconfig == null) {
                cacheconfig = Long.valueOf(EvenNumbersConfigRealmProxy.insertOrUpdate(realm, configObj, cache));
            }
            Table.nativeSetLink(tableNativePtr, columnInfo2.configIndex, rowIndex, cacheconfig.longValue(), false);
            return rowIndex;
        }
    ...
    public static EvenNumbersResult createDetachedCopy(EvenNumbersResult realmObject, int currentDepth, int maxDepth, Map<RealmModel, RealmObjectProxy.CacheData<RealmModel>> cache) {
        EvenNumbersResult unmanagedObject;
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        RealmObjectProxy.CacheData<RealmModel> cachedObject = cache.get(realmObject);
        if (cachedObject == null) {
            unmanagedObject = new EvenNumbersResult();
            cache.put(realmObject, new RealmObjectProxy.CacheData(currentDepth, unmanagedObject));
        } else if (currentDepth >= cachedObject.minDepth) {
            return (EvenNumbersResult) cachedObject.object;
        } else {
            unmanagedObject = (EvenNumbersResult) cachedObject.object;
        ...
        unmanagedObject.realmSet$config(EvenNumbersConfigRealmProxy.createDetachedCopy(realmObject.realmGet$config(), currentDepth + 1, maxDepth, cache));
        return unmanagedObject;
    }

    static EvenNumbersResult update(Realm realm, EvenNumbersResult realmObject, EvenNumbersResult newObject, Map<RealmModel, RealmObjectProxy> cache) {
        realmObject.realmSet$score(newObject.realmGet$score());
        realmObject.realmSet$unixTime(newObject.realmGet$unixTime());
        EvenNumbersConfig configObj = newObject.realmGet$config();
        if (configObj != null) {
            ...
            if (cacheconfig != null) {
                ...
                realmObject.realmSet$config(EvenNumbersConfigRealmProxy.copyOrUpdate(realm, configObj, true, cache));
            }
        } else {
            realmObject.realmSet$config((EvenNumbersConfig) null);
        }
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("EvenNumbersResult = [");
        ...
        stringBuilder.append(realmGet$config() != null ? "EvenNumbersConfig" : "null");
        stringBuilder.append("}");
        stringBuilder.append("]");
    ...
    public boolean equals(Object o) {
        ...
        EvenNumbersResultRealmProxy aEvenNumbersResult = (EvenNumbersResultRealmProxy) o;
        String path = this.proxyState.getRealm$realm().getPath();
        String otherPath = aEvenNumbersResult.proxyState.getRealm$realm().getPath();
        if (path == null ? otherPath != null : !path.equals(otherPath)) {
            return false;
        }
        String tableName = this.proxyState.getRow$realm().getTable().getName();
        String otherTableName = aEvenNumbersResult.proxyState.getRow$realm().getTable().getName();
        if (tableName == null ? otherTableName != null : !tableName.equals(otherTableName)) {
            return false;
        }
        if (this.proxyState.getRow$realm().getIndex() != aEvenNumbersResult.proxyState.getRow$realm().getIndex()) {
            return false;
        }
        return true;
    }
