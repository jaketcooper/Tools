...
/* renamed from: io.realm.WordBlockResultRealmProxy */
public class WordBlockResultRealmProxy extends WordBlockResult implements RealmObjectProxy, WordBlockResultRealmProxyInterface {
    private static final List<String> FIELD_NAMES;
    private WordBlockResultColumnInfo columnInfo;
    private ProxyState<WordBlockResult> proxyState;

    /* renamed from: io.realm.WordBlockResultRealmProxy$WordBlockResultColumnInfo */
    static final class WordBlockResultColumnInfo extends ColumnInfo implements Cloneable {
        public long configIndex;
        public long idIndex;
        public long unixTimeIndex;

        WordBlockResultColumnInfo(String path, Table table) {
            Map<String, Long> indicesMap = new HashMap<>(3);
            this.idIndex = getValidColumnIndex(path, table, "WordBlockResult", IdentityRealmObject.FIELD_ID);
            indicesMap.put(IdentityRealmObject.FIELD_ID, Long.valueOf(this.idIndex));
            this.unixTimeIndex = getValidColumnIndex(path, table, "WordBlockResult", UnixTimeRealmObject.FIELD_UNIX_TIME);
            indicesMap.put(UnixTimeRealmObject.FIELD_UNIX_TIME, Long.valueOf(this.unixTimeIndex));
            this.configIndex = getValidColumnIndex(path, table, "WordBlockResult", "config");
            indicesMap.put("config", Long.valueOf(this.configIndex));
            setIndicesMap(indicesMap);
        }

        public final void copyColumnInfoFrom(ColumnInfo other) {
            WordBlockResultColumnInfo otherInfo = (WordBlockResultColumnInfo) other;
        ...
        public final WordBlockResultColumnInfo clone() {
            return (WordBlockResultColumnInfo) super.clone();
        }
    }
    ...
    public void realm$injectObjectContext() {
        if (this.proxyState == null) {
            ...
            this.columnInfo = (WordBlockResultColumnInfo) context.getColumnInfo();
    ...
    public WordBlockConfig realmGet$config() {
        ...
        return (WordBlockConfig) this.proxyState.getRealm$realm().get(WordBlockConfig.class, this.proxyState.getRow$realm().getLink(this.columnInfo.configIndex), false, Collections.emptyList());
    }

    public void realmSet$config(WordBlockConfig value) {
        if (!this.proxyState.isUnderConstruction()) {
            this.proxyState.getRealm$realm().checkIfValid();
            if (value == null) {
            ...
            if (value != null && !RealmObject.isManaged(value)) {
                value = (WordBlockConfig) ((Realm) this.proxyState.getRealm$realm()).copyToRealm(value);
            }
            Row row = this.proxyState.getRow$realm();
            if (value == null) {
    ...
    public static RealmObjectSchema createRealmObjectSchema(RealmSchema realmSchema) {
        if (realmSchema.contains("WordBlockResult")) {
            return realmSchema.get("WordBlockResult");
        }
        RealmObjectSchema realmObjectSchema = realmSchema.create("WordBlockResult");
        ...
        if (!realmSchema.contains("WordBlockConfig")) {
            WordBlockConfigRealmProxy.createRealmObjectSchema(realmSchema);
        }
        realmObjectSchema.add(new Property("config", RealmFieldType.OBJECT, realmSchema.get("WordBlockConfig")));
        return realmObjectSchema;
    }

    public static Table initTable(SharedRealm sharedRealm) {
        if (sharedRealm.hasTable("class_WordBlockResult")) {
            return sharedRealm.getTable("class_WordBlockResult");
        }
        Table table = sharedRealm.getTable("class_WordBlockResult");
        ...
        if (!sharedRealm.hasTable("class_WordBlockConfig")) {
            WordBlockConfigRealmProxy.initTable(sharedRealm);
        }
        table.addColumnLink(RealmFieldType.OBJECT, "config", sharedRealm.getTable("class_WordBlockConfig"));
        table.addSearchIndex(table.getColumnIndex(IdentityRealmObject.FIELD_ID));
        table.setPrimaryKey(IdentityRealmObject.FIELD_ID);
        return table;
    }

    public static WordBlockResultColumnInfo validateTable(SharedRealm sharedRealm, boolean allowExtraColumns) {
        if (sharedRealm.hasTable("class_WordBlockResult")) {
            Table table = sharedRealm.getTable("class_WordBlockResult");
            ...
            WordBlockResultColumnInfo columnInfo2 = new WordBlockResultColumnInfo(sharedRealm.getPath(), table);
            if (!table.hasPrimaryKey()) {
                ...
                throw new RealmMigrationNeededException(sharedRealm.getPath(), "Invalid type 'WordBlockConfig' for field 'config'");
            } else if (!sharedRealm.hasTable("class_WordBlockConfig")) {
                throw new RealmMigrationNeededException(sharedRealm.getPath(), "Missing class 'class_WordBlockConfig' for field 'config'");
            } else {
                Table table_2 = sharedRealm.getTable("class_WordBlockConfig");
            ...
            throw new RealmMigrationNeededException(sharedRealm.getPath(), "The 'WordBlockResult' class is missing from the schema for this Realm.");
        }
    }

    public static String getTableName() {
        return "class_WordBlockResult";
    }
    ...
    public static WordBlockResult createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update) throws JSONException {
        ArrayList arrayList = new ArrayList(1);
        WordBlockResult obj = null;
        if (update) {
            Table table = realm.getTable(WordBlockResult.class);
            ...
            if (rowIndex != -1) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.schema.getColumnInfo(WordBlockResult.class), false, Collections.emptyList());
                    obj = new WordBlockResultRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            ...
            if (!json.has(IdentityRealmObject.FIELD_ID)) {
                ...
                obj = (WordBlockResultRealmProxy) realm.createObjectInternal(WordBlockResult.class, (Object) null, true, arrayList);
            } else {
                obj = (WordBlockResultRealmProxy) realm.createObjectInternal(WordBlockResult.class, Integer.valueOf(json.getInt(IdentityRealmObject.FIELD_ID)), true, arrayList);
            }
        }
        ...
        if (json.has("config")) {
            if (json.isNull("config")) {
                obj.realmSet$config((WordBlockConfig) null);
            } else {
                obj.realmSet$config(WordBlockConfigRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("config"), update));
            }
        }
        return obj;
    }
    ...
    @TargetApi(11)
    public static WordBlockResult createUsingJsonStream(Realm realm, JsonReader reader) throws IOException {
        boolean jsonHasPrimaryKey = false;
        WordBlockResult obj = new WordBlockResult();
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (name.equals(IdentityRealmObject.FIELD_ID)) {
                ...
                obj.realmSet$config(WordBlockConfigRealmProxy.createUsingJsonStream(realm, reader));
            }
        }
        reader.endObject();
        if (jsonHasPrimaryKey) {
            return (WordBlockResult) realm.copyToRealm(obj);
        }
        throw new IllegalArgumentException("JSON object doesn't have the primary key field 'id'.");
    }

    public static WordBlockResult copyOrUpdate(Realm realm, WordBlockResult object, boolean update, Map<RealmModel, RealmObjectProxy> cache) {
        if ((object instanceof RealmObjectProxy) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().threadId != realm.threadId) {
            ...
            if (cachedRealmObject != null) {
                return (WordBlockResult) cachedRealmObject;
            }
            WordBlockResult realmObject = null;
            ...
            if (canUpdate) {
                ...
                if (rowIndex != -1) {
                    try {
                        objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.schema.getColumnInfo(WordBlockResult.class), false, Collections.emptyList());
                        WordBlockResult realmObject2 = new WordBlockResultRealmProxy();
                        try {
                            ...
                            th = th;
                            WordBlockResult wordBlockResult = realmObject2;
                            objectContext.clear();
                            throw th;
                        }
                    } catch (Throwable th2) {
    ...
    public static WordBlockResult copy(Realm realm, WordBlockResult newObject, boolean update, Map<RealmModel, RealmObjectProxy> cache) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (WordBlockResult) cachedRealmObject;
        }
        WordBlockResult realmObject = (WordBlockResult) realm.createObjectInternal(WordBlockResult.class, Integer.valueOf(newObject.realmGet$id()), false, Collections.emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);
        realmObject.realmSet$unixTime(newObject.realmGet$unixTime());
        WordBlockConfig configObj = newObject.realmGet$config();
        if (configObj != null) {
            WordBlockConfig cacheconfig = (WordBlockConfig) cache.get(configObj);
            if (cacheconfig != null) {
                realmObject.realmSet$config(cacheconfig);
            } else {
                realmObject.realmSet$config(WordBlockConfigRealmProxy.copyOrUpdate(realm, configObj, update, cache));
            }
        } else {
            realmObject.realmSet$config((WordBlockConfig) null);
        }
        return realmObject;
    }

    public static long insert(Realm realm, WordBlockResult object, Map<RealmModel, Long> cache) {
        if ((object instanceof RealmObjectProxy) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(WordBlockResult.class);
        long tableNativePtr = table.getNativeTablePointer();
        WordBlockResultColumnInfo columnInfo2 = (WordBlockResultColumnInfo) realm.schema.getColumnInfo(WordBlockResult.class);
        long pkColumnIndex = table.getPrimaryKey();
        long rowIndex = -1;
        ...
        WordBlockConfig configObj = object.realmGet$config();
        if (configObj == null) {
            return rowIndex;
        }
        Long cacheconfig = cache.get(configObj);
        if (cacheconfig == null) {
            cacheconfig = Long.valueOf(WordBlockConfigRealmProxy.insert(realm, configObj, cache));
        }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel, Long> cache) {
        ...
        while (objects.hasNext()) {
            WordBlockResult object = (WordBlockResult) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, WordBlockResult object, Map<RealmModel, Long> cache) {
        if ((object instanceof RealmObjectProxy) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(WordBlockResult.class);
        ...
        if (configObj != null) {
            Long cacheconfig = cache.get(configObj);
            if (cacheconfig == null) {
                cacheconfig = Long.valueOf(WordBlockConfigRealmProxy.insertOrUpdate(realm, configObj, cache));
            }
            Table.nativeSetLink(tableNativePtr, columnInfo2.configIndex, rowIndex, cacheconfig.longValue(), false);
            return rowIndex;
        }
    ...
    public static WordBlockResult createDetachedCopy(WordBlockResult realmObject, int currentDepth, int maxDepth, Map<RealmModel, RealmObjectProxy.CacheData<RealmModel>> cache) {
        WordBlockResult unmanagedObject;
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        RealmObjectProxy.CacheData<RealmModel> cachedObject = cache.get(realmObject);
        if (cachedObject == null) {
            unmanagedObject = new WordBlockResult();
            cache.put(realmObject, new RealmObjectProxy.CacheData(currentDepth, unmanagedObject));
        } else if (currentDepth >= cachedObject.minDepth) {
            return (WordBlockResult) cachedObject.object;
        } else {
            unmanagedObject = (WordBlockResult) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        unmanagedObject.realmSet$id(realmObject.realmGet$id());
        unmanagedObject.realmSet$unixTime(realmObject.realmGet$unixTime());
        unmanagedObject.realmSet$config(WordBlockConfigRealmProxy.createDetachedCopy(realmObject.realmGet$config(), currentDepth + 1, maxDepth, cache));
        return unmanagedObject;
    }

    static WordBlockResult update(Realm realm, WordBlockResult realmObject, WordBlockResult newObject, Map<RealmModel, RealmObjectProxy> cache) {
        realmObject.realmSet$unixTime(newObject.realmGet$unixTime());
        WordBlockConfig configObj = newObject.realmGet$config();
        if (configObj != null) {
            WordBlockConfig cacheconfig = (WordBlockConfig) cache.get(configObj);
            if (cacheconfig != null) {
                ...
                realmObject.realmSet$config(WordBlockConfigRealmProxy.copyOrUpdate(realm, configObj, true, cache));
            }
        } else {
            realmObject.realmSet$config((WordBlockConfig) null);
        }
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("WordBlockResult = [");
        ...
        stringBuilder.append(realmGet$config() != null ? "WordBlockConfig" : "null");
        stringBuilder.append("}");
        stringBuilder.append("]");
    ...
    public boolean equals(Object o) {
        ...
        WordBlockResultRealmProxy aWordBlockResult = (WordBlockResultRealmProxy) o;
        String path = this.proxyState.getRealm$realm().getPath();
        String otherPath = aWordBlockResult.proxyState.getRealm$realm().getPath();
        if (path == null ? otherPath != null : !path.equals(otherPath)) {
            return false;
        }
        String tableName = this.proxyState.getRow$realm().getTable().getName();
        String otherTableName = aWordBlockResult.proxyState.getRow$realm().getTable().getName();
        if (tableName == null ? otherTableName != null : !tableName.equals(otherTableName)) {
            return false;
        }
        if (this.proxyState.getRow$realm().getIndex() != aWordBlockResult.proxyState.getRow$realm().getIndex()) {
            return false;
        }
        return true;
    }
