...
public class Color3f extends Tuple3f implements Serializable {
    ...
    public final void set(Color color) {
        this.f158x = ((float) color.getRed()) / 255.0f;
        this.f159y = ((float) color.getGreen()) / 255.0f;
        this.f160z = ((float) color.getBlue()) / 255.0f;
    }

    public final Color get() {
        return new Color(Math.round(this.f158x * 255.0f), Math.round(this.f159y * 255.0f), Math.round(this.f160z * 255.0f));
    }
}
